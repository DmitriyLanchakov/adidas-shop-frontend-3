          ...
          <div className="row">
            <div className="col-xs-12 col-lg-4">
              <div className="catalog-item sale">
                <img src={shoes1Image} srcSet={require('./img/adidas-shoes-1@2x.jpg') + ' 2x, ' + require('./img/adidas-shoes-1@3x.jpg') + ' 3x'} alt="Adidas Shoes 1" className="item-image" />
            ...
            <div className="col-xs-12 col-lg-4">
              <div className="catalog-item sale">
                <img src={shoes2Image} srcSet={require('./img/adidas-shoes-2@2x.jpg') + ' 2x, ' + require('./img/adidas-shoes-2@3x.jpg') + ' 3x'} alt="Adidas Shoes 2" className="item-image" />
            ...
            <div className="col-xs-12 col-lg-4">
              <div className="catalog-item">
                <img src={shoes3Image} srcSet={require('./img/adidas-shoes-3@2x.jpg') + ' 2x, ' + require('./img/adidas-shoes-3@3x.jpg') + ' 3x'} alt="Adidas Shoes 3" className="item-image" />
